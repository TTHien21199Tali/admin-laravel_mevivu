        ...
        <div class="container-xl">
            <div class="card">
                <div class="card-header justify-content-between">
                    ...
                    <x-link :href="route('admin.post1.create')" class="btn btn-primary">
                        <i class="ti ti-plus"></i>
                        @lang('add')
                    </x-link>
                </div>
                <div class="card-body">
                    <x-form id="formMultiple" :action="route('admin.post1.action_multiple_record')" type="post" :validate="true">
